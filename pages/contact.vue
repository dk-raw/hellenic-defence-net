<template>
  <div class="container">
    <h1 class="display-3 fw-bold mb-0">Επικοινωνία</h1>
    <hr />
    <div class="row">
    ...
    <div class="row my-3">
      <div class="col-sm text-center mb-4">
        <h4 class="fw-600"><i class="fa-brands fa-x-twitter"></i> Twitter</h4>
        <a href="https://twitter.com/hellenicdefence" target="_blank"
          class="btn btn-outline-primary w-100">@hellenicdefence</a>
      </div>
      <div class="col-sm text-center mb-4">
        <h4 class="fw-600"><i class="fa-brands fa-telegram"></i> Telegram</h4>
